...
public abstract class ActionMode {
     ...
     * a custom com.applite.view has been set.
     *
    ...
    /**
     * Set a custom com.applite.view for this action mode. The custom com.applite.view will take the place of
     * the title and subtitle. Useful for things like search boxes.
     *
     * @param com.applite.view Custom com.applite.view to use in place of the title/subtitle.
     *
     * @see #setTitle(CharSequence)
     * @see #setSubtitle(CharSequence)
     */
    ...
    /**
     * Returns the current custom com.applite.view for this action mode.
     * @return The current custom com.applite.view
     */
     ...
     * present an action mode UI that requires focus, such as an EditText as a custom com.applite.view.
     *
