...
import com.android.applite.model.ImplDownload.DownloadData;
import com.android.applite.model.ImplDownload.RealRunnable;
        ...
        public synchronized void run() {
            ...
            for (int i =0;i<size;i++){
                ...
                switch(data.status){
                    case DownloadManager.STATUS_PENDING:
                    case DownloadManager.STATUS_RUNNING:
                        if (!AppliteConfig.getNetwork(mContext).equals("none")){
                            data.progress += 2;
                        }
                        break;
                }
