...
public class SPUtils {
    ...
    public static final String MOBCLICK_FILE_NAME = "_mobclick";
    public static final String NEXT_TIME_FILE_NAME = "_time";
    public static final String SDK_FILE_NAME = "sdk_file";

    public static final String UPDATE_TIME = "update_time";
    public static final String MOBCLICK_TIME = "mobclick_time";
     ...
     * 保存在手机里面的文件名
     */
    private static String setFileName(Context context, String fileName) {
    ...
    public static void put(Context context, String key, Object object, String fileName) {
        ...
        SharedPreferences sp = context.getSharedPreferences(setFileName(context, fileName), Context.MODE_PRIVATE);
