...
package com.android.dsc.downloads;
...
public class DownloadManager {
    ...
    public final static String COLUMN_ERROR_MSG = Downloads.Impl.COLUMN_ERROR_MSG;
    ...
    public static class Request {
         ...
         * {@link com.android.dsc.downloads.DownloadManager#addCompletedDownload(String, String,
         ...
         * should be called before {@link com.android.dsc.downloads.DownloadManager#enqueue(com.android.dsc.downloads.DownloadManager.Request)} is called.
         */
        ...
        //for Dsc
        public Request setAssumedFileSize(long size){
            return this;
        }
        
        public Request setAgent(String agent){
            mAgent = agent;
            return this;
        }
        ...
        ContentValues toContentValues(String packageName) {
            ...
            putIfNonNull(values,Downloads.Impl.COLUMN_USER_AGENT, mAgent);
    ...
    public static DownloadManager getInstance(Context context){
        if (null == mInstance){
            mInstance = new DownloadManager(context.getContentResolver(),context.getPackageName());
        }
        return mInstance;
    }
    /**
