 ...
 * 
 */
public class MarketUpdateTaskMark extends ATaskMark {
	// Ψһ�ͺ�
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MarketUpdateTaskMark other = (MarketUpdateTaskMark) obj;
	...
	public String toString() {
		return "MarketUpdateTaskMark  [taskMark=" + taskMark + ", taskStatus=" + taskStatus + "]";
	}
