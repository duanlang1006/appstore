...
public abstract class RunAsyncTask<Params, Progress, Result> {
	...
	public RunAsyncTask() {
		...
		mFuture = new FutureTask<Result>(mWorker) {
			...
			protected void done() {
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskResult<Result>(RunAsyncTask.this,
						result));
				message.sendToTarget();
			}
		};
	 ...
	 */
	public final RunAsyncTask<Params, Progress, Result> execute(Params... params) {
