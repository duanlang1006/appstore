...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "homepage_data";

    public static final String ISHOMEPAGE = "is_homepage";
    public static final String HOMEPAGE_POSITION = "homepage_position";
    public static final String LOGO_NEXT_TIME = "homepage_next_time";
    public static final String LOGO_SHOW_TIME = "homepage_show_time";
